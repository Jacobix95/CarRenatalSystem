...
public class ShowSpecUserRent implements Operation {
    ...
    public void operation(Database database, Scanner scanner, User user) {
        System.out.print("Enter the User ID to view their rental history: ");
        ...
        try (Connection conn = database.getConnection();
            ...
            System.out.println("Rental History for User ID: " + userId);
            System.out.println("--------------------------------------------------------------");
            ...
            if (!hasRents) {
                System.out.println("No rental records found for User ID: " + userId);
            }
